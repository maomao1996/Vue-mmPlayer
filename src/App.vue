<template>
    <div id="app" class="mmPlayer">
                ...
                <div class="mmPlayer-list-box" style="min-width: 0;min-height: 0" v-show="listIndex!==0">
                    <div v-show="listIndex===1" class="mmPlayer-list">
                        ...
                        <div class="list-item" v-for="(item,index) in musicList" :key="index"
                             :class="{on:currentIndex===index&&isPlay}">
        ...
        <!--播放器-->
        <audio ref="audio" :src="'https://music.163.com/song/media/outer/url?id='+currentUrl+'.mp3'" @canplay="canplay"
...
<script>
    import MmProgress from 'components/mm-progress/mm-progress'
